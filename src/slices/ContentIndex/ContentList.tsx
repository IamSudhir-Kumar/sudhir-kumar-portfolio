...
type ContentListProps = {
  ...
  contentType: Content.ProjectDocumentDataSlicesSlice["primary"]["content_type"];
  fallbackItemImage: Content.ProjectDocumentDataSlicesSlice["primary"]["fallback_item_image"];
  viewMoreText: Content.ProjectDocumentDataSlicesSlice["primary"]["view_more_text"];
};
